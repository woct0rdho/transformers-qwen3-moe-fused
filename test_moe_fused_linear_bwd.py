...
def main():
    ...
    output_auto = moe_fused_linear_naive(input_auto, weight_auto, m_offsets)
    ...
    output_grouped_gemm = moe_fused_linear(input_grouped_gemm, weight_grouped_gemm, m_offsets)
